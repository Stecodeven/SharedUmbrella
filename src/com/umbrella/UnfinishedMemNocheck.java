...
@WebServlet(name = "UnfinishedMemNocheck", urlPatterns = { "/UnfinishedMemNocheck" })
public class UnfinishedMemNocheck extends HttpServlet {
	/**
	 * 
	 */
			...
			throws ServletException, IOException
	{
		...
		try {
			...
			String sql = "select orderNo,memNo,orderTime,placeNo from Orders where memNo='"+ memNo + "'";
