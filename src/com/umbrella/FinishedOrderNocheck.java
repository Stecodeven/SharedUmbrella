...
@WebServlet(name = "FinishedOrderNocheck", urlPatterns = { "/FinishedOrderNocheck" })
public class FinishedOrderNocheck extends HttpServlet {
	/**
	 * 
	 */
			...
			throws ServletException, IOException
	{
		...
		try {
			...
			String sql = "select orderNo,memNo,orderTime,placeNo from ReturnUM where orderNo='"+ orderNo + "'";
