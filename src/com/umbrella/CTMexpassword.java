...
@WebServlet(name = "CTMexpasswordServlet", urlPatterns = { "/CTMexpassword" })
public class CTMexpassword extends HttpServlet {
	/**
	 * 
	 */
			...
			throws ServletException, IOException
	{
		 ...
		 try {
				...
				if(password1.equals(password)){
		            ...
		            String sql = "update Member set memPasswd='"+password2+"' where memNo='"+username+"'";
